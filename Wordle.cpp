...
// Attempted TODO
// Attempted TODO update the Board with the passed Move parameter
...
// attempted TO DO select the right GAMEOUTCOME for this game
GAMEOUTCOME  Wordle::determineGameOutcome( ) const
{
    ...
    if (mCurrentScore.isExactMatch()==true)
        outcome = GAMEWON;
